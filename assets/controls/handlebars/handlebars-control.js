...
!( jQuery( function($){
    ...
    conduitBuildUI = function( app ){
        ...
        // sortables
        if( $('.caldoza-sortable').length ){
            $('.caldoza-sortable').each( function(){
                var sort = $(this),
                    options = {
                        forcePlaceholderSize : true,
                        placeholder: "caldoza-sortable-placeholder"
                    };
    ...
    $(document).on('click', '.caldoza-notice .notice-dismiss', function(){
        var parent =  $( this ).closest( '.caldoza-notice' );
    ...
    $(document).on( 'click', '[data-modal-node]', function( e ) {
        ...
        if( type !== 'delete' ){
            try{
                data = clicked.closest('.caldoza-modal-wrap').getObject();
            }catch (e){
                return;
            }
        }
    ...
    $(document).on('caldoza.itemsubmit', function(){
        conduitPrepObject();
    })
    // register apps
