...
/**
 * CLDZA_LMAN Post Type class for adding custom post types
 * @package caldoza\ui
 * @author  David Cramer
 */
class post_type extends caldoza {
	...
	/**
	 * Define core CLDZA_LMAN styling to identify CLDZA_LMAN post types
	 *
	 * @since 1.0.0
	 * @access public
	 */
	public function set_assets() {
		$this->assets['style']['post'] = $this->url . 'assets/css/post' . CLDZA_LMAN_ASSET_DEBUG . '.css';
		parent::set_assets();
	}
