...
class modal extends panel {
	...
	public function is_submitted() {
		...
		return isset( $data[ 'caldozaNonce_' . $this->id() ] ) && wp_verify_nonce( $data[ 'caldozaNonce_' . $this->id() ], $this->id() );
	}
	...
	public function modal_template() {
		...
		$output = wp_nonce_field( $this->id(), 'caldozaNonce_' . $this->id(), true, false );
	...
	protected function set_active_styles() {
		...
		$style = 'h3#' . $this->id() . '_caldozaModalLable { background: ' . $this->base_color() . '; }';
		$style .= '#' . $this->id() . '_caldozaModal.caldoza-modal-wrap > .caldoza-modal-body:after {background: url(' . $this->url . 'assets/svg/loading.php?base_color=' . urlencode( str_replace( '#', '', $this->base_color() ) ) . ') no-repeat center center;}';
