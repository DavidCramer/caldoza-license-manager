...
class section extends panel {
	...
	public function set_assets() {
		...
		$this->assets['style']['sections'] = $this->url . 'assets/css/sections' . CLDZA_LMAN_ASSET_DEBUG . '.css';
	...
	public function render() {
		...
		$output = '<div id="' . esc_attr( $this->id() ) . '" class="caldoza-section" aria-hidden="' . esc_attr( $this->struct['active'] ) . '">' . $this->description();

		$output .= '<div class="caldoza-section-content">';
