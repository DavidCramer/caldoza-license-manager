 ...
 * @since 1.0.0
 */
class handlebars extends \caldoza\ui\control {
	...
	public function render() {
		...
		$output = '<div class="caldoza-tab-canvas" data-app="' . esc_attr( $this->name() ) . '" ' . esc_attr( $this->build_attributes() ) . '></div>';
	...
	public function set_assets() {
		...
		$this->assets['script']['handlebars-control']  = array(
			'src'  => $this->url . 'assets/controls/handlebars/handlebars-control' . CLDZA_LMAN_ASSET_DEBUG . '.js',
			'deps' => array( 'baldrick' ),
		);
