...
class metabox extends panel {
	...
	public function set_assets() {
		...
		$this->assets['style']['metabox'] = $this->url . 'assets/css/metabox' . CLDZA_LMAN_ASSET_DEBUG . '.css';
	...
	protected function set_active_styles() {
		...
		$style = '#' . $this->id() . '.caldoza-top-tabs > .caldoza-panel-tabs > li[aria-selected="true"] a,';
		$style .= '#side-sortables #' . $this->id() . ' > .caldoza-panel-tabs > li[aria-selected="true"] a {';
		$style .= 'box-shadow: 0 3px 0 ' . $this->base_color() . ' inset; }';

		$style .= '#' . $this->id() . ' > .caldoza-panel-tabs > li[aria-selected="true"] a {';
