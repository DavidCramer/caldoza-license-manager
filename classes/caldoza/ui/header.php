...
class header extends section {
	 ...
	 * @var array
	 */
	public $attributes = array( 'class' => 'caldoza-title' );
	...
	public function label() {
		...
		if ( ! empty( $this->struct['label'] ) ) {
			$output .= '<span class="caldoza-text">' . esc_html( $this->struct['label'] ) . '</span>';
		}
	...
	public function set_assets() {
		...
		$this->assets['style']['header'] = $this->url . 'assets/css/header' . CLDZA_LMAN_ASSET_DEBUG . '.css';
